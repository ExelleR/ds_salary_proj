...
def get_jobs(keyword, num_jobs, verbose, path, slp_time):
    ...
    # url = 'https://www.glassdoor.com/Job/jobs.htm?sc.keyword="' + \
    #       keyword + '&locT=C&locId=1147401&jobType='
    url = 'https://www.glassdoor.com/Job/jobs.htm?suggestCount=0&suggestChosen=false&clickSource=searchBtn&typedKeyword=' + \
        keyword + '&sc.keyword=data+scientist&locT=&locId=&jobType='
    driver.get(url)
    jobs = []
    # job_grid = driver.find_element_by_css_selector(".jlGrid")
    ...
    while len(jobs) < num_jobs:
        ...
        try:
            ...
            driver.find_element_by_css_selector(
                "#JAModal > div > div.modal_main.jaCreateAccountModalWrapper > span").click()
            print("x out worked")
        ...
        for job_button in job_buttons:
            ...
            # wait.until(EC.visibility_of_element_located(By.XPATH,'.//div[@class="employerName"]'))
            ...
            try:
                salary_estimate = driver.find_element_by_css_selector(
                    "#HeroHeaderModule > div.empWrapper.ctasTest > div.empInfo.newDetails > div.salary > span").text
            except NoSuchElementException:
            ...
            try:
                ...
                try:
                    ...
                    headquarters = driver.find_element_by_xpath(
                        '//*[@id="HeroHeaderModule"]/div[3]/div[1]/div[3]').text
                except NoSuchElementException:
                    headquarters = -1
